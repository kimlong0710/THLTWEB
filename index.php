			...
			<div class="preload"><div></div></div>
				<div id="lof-main-outer">
					<ul class="lof-main-wapper">
						<li><img src="img/images/Banner1.jpg" width="1000" height="350"></li>
						<li><img src="img/images/Banner2.jpg" width="1000" height="350"></li>
					...
					<div onClick="return false" href="" class="lof-next">Next</div>
					  <div class="lof-navigator-outer">
							<ul class="lof-navigator">
							   <li><img src="img/images/Banner1.jpg" width="70" height="25" /></li>       		
							   <li><img src="img/images/Banner2.jpg" width="70" height="25" /></li>       		
	...
	<div id="footer">
		...
		<div id="bg-footer">
			<div id="noidungfooter">
				...
				<div id="noidung">
					<ul>
						<li><span id="tencongty">Công Ty TNHH ĐIỆN THOẠI LONGHOANG APPLE STORE</span></li> <br>
						
						<li>Địa chỉ: 180 Cao Lỗ Phường 4 Quận 8 </li>
						<li>Điện thoại: 0123456789 - Hotline:  0123456789</li>
						<li>Email:  longhoangapple@gmail.com</li>
					</ul>
				</div><!-- End .noidung -->
				<div id="thanhngang">
				...
				<div id="copyright">
					<p>Sinh Viên: Nguyễn Kim Long | Lớp : D17_TH03 | Gmail: DH51701886@student.stu.edu.vn<p>
					<p>Sinh Viên: Đặng Chí Hoàng | Lớp : D17_TH03 | Gmail: DH51700246@student.stu.edu.vn</p>
				</div><!-- End .copyright -->
