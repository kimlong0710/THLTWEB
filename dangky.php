...
<form action="update_dangky.php" method="post" name="frm" onsubmit="return dangky()">
	<div class="dangky">
		...
		<table>
		<tr>
			<td>Tên đăng nhập  <font color="red">*</font> </td><td class="input"> <input type="text" name="username" size="40"></td>
		</tr>
		<tr>
			<td>Tên người dùng <font color="red">*</font> </td><td class="input"><input type="text" name="tennd" size="40"></td>
		</tr>
		<tr>
			<td>Mật khẩu <font color="red">*</font> </td><td class="input"><input type="password" name="password" size="40" ></td>
		</tr>
		<tr>
			<td>Nhập lại mật khẩu <font color="red">*</font> </td><td class="input"><input type="password" name="password" size="40"></td>
		</tr>
		<tr>
...
<script language="javascript">
 	function  dangky()
	{
		...
		if(frm.user.value.length<0)
	 	{
			alert("Tên đăng nhập phải lớn hơn 0 ký tự");
			frm.user.focus();
			return false;	
		}
		if(frm.pass.value=="")
 ...
 <form action="update_dangky.php" method="post" name="frm" onsubmit="return dangky()">
	<div class="dangky">
		...
		<tr>
			<td>Mật khẩu <font color="red">*</font> </td><td class="input"><input type="password" name="passwords" size="40" ></td>
		</tr>
		<tr>
			<td>Nhập lại mật khẩu <font color="red">*</font> </td><td class="input"><input type="password" name="passwords" size="40"></td>
		</tr>
		<tr>
			<td>Email <font color="red">*</font> </td><td class="input"><input type="text" name="email" size="40"></td>
		</tr>
		<!-- <tr>
			<td>Ngày sinh </td><td class="input"><input type="date" name=" "></td>
		</tr> -->
		<!-- <tr>
			<td>Giới tính </td><td class="input">
				<select name=" ">
		...
		<!-- <tr>
			<td>Điện thoại <font color="red">*</font> </td><td class="input"><input type="text" name=" " size="40"></td>
		</tr>
		<tr>
			<td>Địa chỉ  </td><td class="input"><textarea name=" "></textarea></td>
		</tr> -->
		<tr>
			<td colspan=2 class="btndangky">
				<button type="submit" name="submit">Đăng ký</button>
