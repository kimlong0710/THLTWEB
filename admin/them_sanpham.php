...
<?php
	...
	//	$hinhanh=$_POST['hinhanh'];
		...
		$madm=$_POST['madm'];
		$mansx=$_POST['idnsx'];
		$insert="INSERT INTO sanpham ( `idnsx`, `madm`, `tensp`, `hinhanh`, `mau`, `chitiet`, `soluong`, `daban`, `gia`, `khuyenmai1`, `khuyenmai2`, `ngaycapnhat`, `trangthai`) 
		VALUES ( '$mansx', '$madm', '$ten_sanpham', '$file__name__', '$mau', '$chitiet', '$soluong', '0', '$gia', '$khuyenmai1', '$khuyenmai2', CURRENT_TIMESTAMP, '1'); ";
      ...
      <table>
			...
			<tr>
				...
				<td>
                    ...
                    <?php
						$show = mysql_query("SELECT * FROM nhasx");
						while($show1 = mysql_fetch_array($show))
						{
							$idnsx1 = $show1['idnsx'];	
							$tennsx1 = $show1['tennsx'];
							echo "<option value='".$idnsx1."'>".$tennsx1."</option>";	
						}
                	?>
                </td>
            </tr>
...
<script language="javascript">
 	function  kiemtra()
	{
		...
		if(frm.tensp.value=="")
	 	{
			echo "Bạn chưa nhập tên SP. Vui lòng kiểm tra lại";
			frm.tensp.focus();
			return false;	
		}
